...
<div class="bg-yellow" id="sidebar-wrapper">
    ...
    <div class="text-left list-group list-group-flush my-3">
        <a href="index.php" class="px-4 py-1 list-group-item-action bg-transparent second-text"><button class="w-100  btn1 text-black fs-6 fw-bold <?php if(basename($_SERVER['REQUEST_URI']) == 'index.php') echo 'standard';?>" type="submit"><img class="mleft pb-1" src="icons/Home.svg" alt="">&nbsp;&nbsp;Home</button></a>
        ...
        <a href="students.php" class="px-4 py-1 list-group-item-action bg-transparent second-text fw-bold"><button class="w-100 btn1 text-black fs-6 fw-bold <?php if(basename($_SERVER['REQUEST_URI']) == 'students.php') echo 'standard';?>" type="submit"><img class="mleft pb-1" src="icons/students.svg" alt="">&nbsp;&nbsp;Students</button></a>
        <a href="payment.php" class="px-4 py-1 list-group-item-action bg-transparent second-text fw-bold"><button class="w-100 btn1 text-black fs-6 fw-bold <?php if(basename($_SERVER['REQUEST_URI']) == 'payment.php') echo 'standard';?>" type="submit"><img class="mleft px-1 pb-1" src="icons/Payment.svg" alt="">&nbsp;Payment</button></a>
